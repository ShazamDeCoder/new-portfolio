...
const Growth = () => {
  const features = [
    {
      id: 1,
      image: process.env.PUBLIC_URL + "/images/second-sales-sub-1.svg",
      title: "Order Management",
      desc: "Receive and manage orders directly from your dashboard.",
    },
    {
      id: 2,
      image: process.env.PUBLIC_URL + "/images/second-sales-sub-2.svg",
      title: "Automatic Payout",
      desc: "Get paid automatically to your bank account.",
    },
    {
      id: 3,
      image: process.env.PUBLIC_URL + "/images/second-sales-sub-3.svg", 
    ...
    <div>
      <section className="w-full bg-white py-16 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2">
          <img
            src={process.env.PUBLIC_URL + "/images/second-sales-2.png"}
            alt="Grow with Heyfood"
            className="w-[500px] h-[500px] ml-[40px] rounded-4xl shadow-md"
          />
        </div>
